...
def get_prompt_template():
    ...
    The resume should include the following sections: Personal Information, Summary, Projects, Skills, and Education.

    - Personal Information: Assume the user's name is {name}.
    - Summary: Summarize the user's professional experience and key contributions.
    - Projects: For each project, use the STAR method to describe the user's involvement:
